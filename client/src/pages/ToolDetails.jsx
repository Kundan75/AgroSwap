...
import {
  MapPin, ShieldCheck, Zap, Fuel, Settings,
  UserCheck, MessageSquare,
  Share2, Heart, Scale, Clock, Truck,
  Phone
} from 'lucide-react';
import {
                  ...
                  {tabValue === 1 && (
                    <div className="space-y-4">
                      <div className="flex justify-between p-3 border-b border-white/20">
                        ...
                        <span className="font-bold text-slate-800">{tool?.power}</span>
                      </div>
                      <div className="flex justify-between p-3 border-b border-white/20">
                ...
                <GlassCard className="p-8 relative overflow-hidden border-emerald-200/60">
                  ...
                  <div className="relative z-10 space-y-6">
                    ...
                    <div className="w-full">
                      <div className="bg-white/50 p-4 rounded-2xl border border-white/40 w-full">
                        ...
                        {/* Selected dates */}
                        {range?.from && (
                          <div className="mt-4 text-sm font-semibold text-slate-700 bg-white/60 p-3 rounded-xl">
                            <p>From: {range.from.toDateString()}</p>
                            <p>To: {range.to?.toDateString()}</p>
                          </div>
                        )}
                      </div>
                    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-4">
              <GlassCard className="p-8 flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold text-slate-800">{tool?.owner.fullName}</h3>
                <p className="text-xs font-bold text-emerald-600 uppercase mb-6">Verified Owner</p>
                ...
                <div className="flex gap-2 w-full">
                  ...
                  <Button fullWidth variant="outlined" startIcon={<Phone size={18} />} className="rounded-xl border-slate-200 text-slate-600 font-bold normal-case">{tool?.owner.mobile}</Button>
                </div>
              </GlassCard>
            </div>
          </div>
